...
public class DefinitionParserFactory {
    ...
    public static DefinitionParser getParser() {
        ...
        throw new RuntimeException("No XML Parsers found. Choose a dependency: org.fhir:ucum.xmlpull.codelibs-xpp3 (Java 9+), org.fhir:ucum.xmlpull.android (Native Android), org.fhir:ucum.xmlpull.xpp3 (old Java)");
    }
}
